...
const Contact = () => {
  ...
  return (
    <div className="w-full relative bg-[#fff3d9] overflow-hidden flex flex-col items-start pt-14 pb-[85px] pl-[74px] pr-[174px] box-border gap-[100px] text-left text-[45px] text-[#000] font-[Inter] md:pr-[74px] md:box-border">
