...
const ProjectPageDevThisPortfolio = () => {
  return (
    <div className="w-full relative overflow-hidden flex flex-col items-start pt-14 pb-[85px] pl-[74px] pr-[174px] box-border gap-[120px] bg-[url('/Project-page-dev-this-portfolio@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-[45px] text-[#fff] font-[Inter] md:pr-[74px] md:box-border">
