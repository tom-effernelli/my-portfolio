...
const NavigationBarArtsSelected = ({ className = "" }) => {
  ...
  return (
    <>
      ...
      {!isDropdownOpen && (
        <div
          className={`navigation-bar-arts w-[1524px] bg-[#000] border-[#fff] border-solid border-b-[1px] box-border max-w-full h-[101px] lg:h-[90px] md:h-[80px] sm:h-[60px] overflow-hidden flex items-center justify-between py-0 px-[45px] lg:px-[35px] md:px-[30px] sm:px-[20px] gap-0 text-left text-[29px] lg:text-[26px] md:text-[24px] sm:text-[18px] text-[#fff] ${className}`}
        >
