...
const FooterHomeAboutContact = ({ className = "" }) => {
  ...
  return (
    <div
      className={`w-[1524px] bg-[#090909] max-w-full h-[693px] overflow-hidden flex flex-col items-start pt-14 pb-20 pl-[74px] pr-[174px] box-border gap-[54px] text-left text-[35px] text-[#fff] font-[Inter] md:pr-[74px] md:box-border ${className}`}
    >
