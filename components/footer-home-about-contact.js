...
const FooterHomeAboutContact = ({ className = "" }) => {
  ...
  return (
    <div
      className={`footer-home-about-contact w-full bg-[#090909] h-[693px] sm:h-[600px] overflow-hidden flex flex-col items-start pt-14 pb-20 pl-[74px] xs:pl-[37px] pr-[74px] xs:pr-[37px] box-border gap-[54px] sm:gap-[40px] text-left text-[35px] text-[#fff] md:box-border ${className}`}
    >
      ...
      <div className="self-stretch flex-1 flex flex-col items-start lg:gap-2.5 md:gap-2.5 sm:gap-1 text-[29px]">
