...
const DropdownMenuHomeSelected = ({ className = "" }) => {
  return (
    <div
      className={`w-full bg-[#fff3d9] border-[#000] border-solid border-b-[2px] box-border max-w-full h-[380px] flex flex-col items-start pt-5 px-5 pb-10 gap-2.5 text-left text-[29px] text-[#000] ${className}`}
    >
      {/* Icône de fermeture en haut à droite */}
      <div className="self-stretch flex-1 border-[#000] border-solid border-b-[2px] overflow-hidden flex items-center justify-end pt-0 px-0 pb-[5px]">
        <Image
