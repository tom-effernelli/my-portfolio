...
const DropdownMenuContactSelected = ({ className = "", onClose }) => {
  return (
    <div
      className={`w-full bg-[#fff3d9] border-[#000] border-solid border-b-[2px] box-border max-w-full h-[380px] flex flex-col items-start pt-5 pl-[45px] pr-[45px] pb-10 gap-2.5 text-left text-[29px] text-[#000] ${className}`}
    >
