  ...
  return (
    <>
      ...
      {!isDropdownOpen && (
        ...
        >
      <Link href="/" className="w-[50px] lg:w-[45px] md:w-[40px] sm:w-[30px] relative bg-[#fff] border-[#000] border-solid border-[5px] lg:border-[4px] md:border-[4px] sm:border-[3px] box-border h-[50px] lg:h-[45px] md:h-[40px] sm:h-[30px] cursor-pointer" />
