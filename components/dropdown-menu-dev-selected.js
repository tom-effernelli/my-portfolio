...
const DropdownMenuDevSelected = ({ className = "", onClose }) => {
  return (
    <div
      className={`dropdown-menu-dev w-full bg-[#000] border-[#fff] border-solid border-b-[2px] box-border max-w-full h-[380px] flex flex-col items-start pt-5 pl-[45px] xs:pl-[23px] pr-[45px] xs:pr-[23px] pb-10 gap-2.5 text-left lg:text-[29px] md:text-[26px] sm:text-[22px] text-[#fff] ${className}`}
    >
