...
const DropdownMenuArtsSelected = ({ className = "", onClose }) => {
  return (
    <div
      className={`dropdown-menu-arts w-full bg-[#000] border-[#fff] border-solid border-b-[2px] box-border max-w-full h-[380px] xs:h-[300px] flex flex-col items-start pt-5 xs:pt-4 pl-[45px] xs:pl-[23px] pr-[45px] xs:pr-[23px] pb-10 xs:pb-8 gap-2.5 xs:gap-2 text-left lg:text-[29px] md:text-[26px] sm:text-[22px] xs:text-[20px] text-[#fff] ${className}`}
    >
