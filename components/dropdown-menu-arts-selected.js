...
const DropdownMenuArtsSelected = ({ className = "", onClose }) => {
  return (
    <div
      className={`dropdown-menu-arts w-full bg-[#000] border-[#fff] border-solid border-b-[2px] box-border max-w-full h-[380px] flex flex-col items-start pt-5 pl-[45px] pr-[45px] pb-10 gap-2.5 text-left text-[29px] text-[#fff] ${className}`}
    >
